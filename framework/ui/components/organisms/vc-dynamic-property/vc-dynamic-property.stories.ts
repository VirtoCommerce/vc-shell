...
const meta = {
  ...
  argTypes: {
    ...
    hideLabel: {
      description:
        "Hides the control's own visible label so the consumer can render its own label row. The display name is still forwarded as the control's accessible name.",
      control: "boolean",
      table: {
        type: { summary: "boolean" },
        defaultValue: { summary: "false" },
