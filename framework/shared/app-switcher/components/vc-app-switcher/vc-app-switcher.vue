<template>
  ...
  >
    ...
    <div
      ...
      class="tw-px-4 tw-py-3.5 tw-bg-white drop-shadow-[4px_4px_20px_rgba(47,86,108,0.25)] tw-absolute tw-z-[10000] tw-rounded tw-top-[var(--app-bar-height)] tw-left-0"
    >
      <ul class="tw-flex tw-flex-col gap-3 tw-overflow-hidden">
        <li
        ...
        >
          <img
            ...
            :alt="`icon_${item.id}`"
            class="w-5 tw-h-5 tw-mr-2 tw-shrink-0"
          />
          <p
            class="tw-font-normal tw-text-sm tw-text-[#727C87] tw-truncate tw-group-hover:tw-opacity-80"
          >
            {{ item.title }}
          </p>
        </li>
