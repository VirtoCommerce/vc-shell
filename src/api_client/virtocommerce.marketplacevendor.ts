...
export class VcmpSellerCatalogClient extends AuthApiBase {
  ...
  getOfferByIdGET(offerId: string): Promise<Offer> {
    ...
    if (offerId === undefined || offerId === null) throw new Error("The parameter 'offerId' must be defined.");
  ...
  bulkDeleteOffers(body?: BulkOffersDeleteCommand | undefined): Promise<void> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.processBulkDeleteOffers(_response);
      });
  }
  ...
  getVideoById(videoId: string): Promise<Video> {
    ...
    if (videoId === undefined || videoId === null) throw new Error("The parameter 'videoId' must be defined.");
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.processGetVideoById(_response);
      });
  }

  protected processGetVideoById(response: Response): Promise<Video> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  protected processUpdate(response: Response): Promise<Video[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(Video.fromJS(item));
        } else {
          result200 = <any>null;
        }
        return result200;
...
export class VcmpSellerOrdersClient extends AuthApiBase {
  ...
  protected processUpdateOrder(response: Response): Promise<CustomerOrder> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
...
export class VcmpSellerRatingAndReviewsClient extends AuthApiBase {
  ...
  getSellerRatingById(sellerId: string): Promise<SellerRating> {
    ...
    if (sellerId === undefined || sellerId === null) throw new Error("The parameter 'sellerId' must be defined.");
...
export class VcmpSellerSecurityClient extends AuthApiBase {
  ...
  sendInvitation(memberId?: string | undefined): Promise<void> {
    ...
    if (memberId === null) throw new Error("The parameter 'memberId' cannot be null.");
...
export class VcmpSmClient extends AuthApiBase {
  ...
  getStateMachineInstanceById(instanceId: string): Promise<StateMachineInstance> {
    ...
    if (instanceId === undefined || instanceId === null) throw new Error("The parameter 'instanceId' must be defined.");
  ...
  createNewInstance(
    ...
    if (definitionId === undefined || definitionId === null)
      throw new Error("The parameter 'definitionId' must be defined.");
    url_ = url_.replace("{definitionId}", encodeURIComponent("" + definitionId));
    if (instanceId === null) throw new Error("The parameter 'instanceId' cannot be null.");
  ...
  fire(instanceId: string, trigger: string, entityId: string): Promise<StateMachineInstance> {
    ...
    if (instanceId === undefined || instanceId === null) throw new Error("The parameter 'instanceId' must be defined.");
    url_ = url_.replace("{instanceId}", encodeURIComponent("" + instanceId));
    if (trigger === undefined || trigger === null) throw new Error("The parameter 'trigger' must be defined.");
  ...
  protected processGetSyncClients(response: Response): Promise<ISyncClient[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(ISyncClient.fromJS(item));
        } else {
          result200 = <any>null;
        }
        return result200;
...
export class BulkOffersDeleteCommand implements IBulkOffersDeleteCommand {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["offerIds"])) {
        ...
        for (let item of _data["offerIds"]) this.offerIds!.push(item);
      }
      this.query = _data["query"] ? SearchOffersQuery.fromJS(_data["query"]) : <any>undefined;
      this.all = _data["all"];
      this.pushNotification = _data["pushNotification"]
        ? SellerPushNotification.fromJS(_data["pushNotification"])
        : <any>undefined;
    }
  }
  ...
  static fromJS(data: any): BulkOffersDeleteCommand {
    data = typeof data === "object" ? data : {};
    let result = new BulkOffersDeleteCommand();
    result.init(data);
    return result;
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.offerIds)) {
      data["offerIds"] = [];
      for (let item of this.offerIds) data["offerIds"].push(item);
    }
...
export class CatalogProduct implements ICatalogProduct {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["properties"])) {
        ...
        for (let item of _data["properties"]) this.properties!.push(Property.fromJS(item));
      }
      if (Array.isArray(_data["excludedProperties"])) {
        this.excludedProperties = [] as any;
        for (let item of _data["excludedProperties"]) this.excludedProperties!.push(ExcludedProperty.fromJS(item));
      }
      if (Array.isArray(_data["propertyValues"])) {
        this.propertyValues = [] as any;
        for (let item of _data["propertyValues"]) this.propertyValues!.push(PropertyValue.fromJS(item));
      }
      ...
      if (Array.isArray(_data["links"])) {
        this.links = [] as any;
        for (let item of _data["links"]) this.links!.push(CategoryLink.fromJS(item));
      }
      if (Array.isArray(_data["variations"])) {
        this.variations = [] as any;
        for (let item of _data["variations"]) this.variations!.push(Variation.fromJS(item));
      }
      (<any>this).seoObjectType = _data["seoObjectType"];
      if (Array.isArray(_data["seoInfos"])) {
        this.seoInfos = [] as any;
      ...
      if (Array.isArray(_data["reviews"])) {
        this.reviews = [] as any;
        for (let item of _data["reviews"]) this.reviews!.push(EditorialReview.fromJS(item));
      }
      ...
      if (Array.isArray(_data["outlines"])) {
        ...
        for (let item of _data["outlines"]) this.outlines!.push(Outline.fromJS(item));
      }
      (<any>this).isInherited = _data["isInherited"];
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.excludedProperties)) {
      ...
      for (let item of this.excludedProperties) data["excludedProperties"].push(item.toJSON());
    }
    if (Array.isArray(this.propertyValues)) {
      data["propertyValues"] = [];
      for (let item of this.propertyValues) data["propertyValues"].push(item.toJSON());
    }
    ...
    if (Array.isArray(this.referencedAssociations)) {
      ...
      for (let item of this.referencedAssociations) data["referencedAssociations"].push(item.toJSON());
    }
...
export class Category implements ICategory {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["descriptions"])) {
        ...
        for (let item of _data["descriptions"]) this.descriptions!.push(CategoryDescription.fromJS(item));
      }
      (<any>this).imgSrc = _data["imgSrc"];
      if (Array.isArray(_data["images"])) {
        this.images = [] as any;
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.descriptions)) {
      data["descriptions"] = [];
      for (let item of this.descriptions) data["descriptions"].push(item.toJSON());
    }
    data["imgSrc"] = this.imgSrc;
    if (Array.isArray(this.images)) {
      data["images"] = [];
...
export class CategorySearchCriteria implements ICategorySearchCriteria {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["outerIds"])) {
        ...
        for (let item of _data["outerIds"]) this.outerIds!.push(item);
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.outerIds)) {
      data["outerIds"] = [];
      for (let item of this.outerIds) data["outerIds"].push(item);
    }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(Category.fromJS(item));
      }
    }
  }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.expressionTree = _data["expressionTree"]
        ? DynamicCommissionFeeTree.fromJS(_data["expressionTree"])
        : <any>undefined;
    }
  }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.searchCriteria = _data["searchCriteria"]
        ? CategorySearchCriteria.fromJS(_data["searchCriteria"])
        : <any>undefined;
    }
  }
...
export class CreateSellerCommand implements ICreateSellerCommand {
  ...
  init(_data?: any) {
    if (_data) {
      this.sellerName = _data["sellerName"];
      this.ownerDetails = _data["ownerDetails"]
        ? SellerOwnerDetails.fromJS(_data["ownerDetails"])
        : new SellerOwnerDetails();
      if (Array.isArray(_data["categoryIds"])) {
        this.categoryIds = [] as any;
        for (let item of _data["categoryIds"]) this.categoryIds!.push(item);
      }
...
export class DynamicCommissionFeeTree implements IDynamicCommissionFeeTree {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["availableChildren"])) {
        ...
        for (let item of _data["availableChildren"]) this.availableChildren!.push(IConditionTree.fromJS(item));
      }
      if (Array.isArray(_data["children"])) {
        this.children = [] as any;
        for (let item of _data["children"]) this.children!.push(IConditionTree.fromJS(item));
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.availableChildren)) {
      ...
      for (let item of this.availableChildren) data["availableChildren"].push(item.toJSON());
    }
...
export class ExportDataQuery implements IExportDataQuery {
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.includedProperties)) {
      ...
      for (let item of this.includedProperties) data["includedProperties"].push(item.toJSON());
    }
    data["skip"] = this.skip;
    data["take"] = this.take;
...
export class FulfillOrderCommand implements IFulfillOrderCommand {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.sellerName = _data["sellerName"];
      this.orderId = _data["orderId"];
      this.fulfillDetails = _data["fulfillDetails"]
        ? FulfillOrderDetails.fromJS(_data["fulfillDetails"])
        : <any>undefined;
    }
  }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["availableChildren"])) {
        ...
        for (let item of _data["availableChildren"]) (<any>this).availableChildren!.push(IConditionTree.fromJS(item));
      }
      if (Array.isArray(_data["children"])) {
        (<any>this).children = [] as any;
        for (let item of _data["children"]) (<any>this).children!.push(IConditionTree.fromJS(item));
      }
    }
  }
...
export class Offer implements IOffer {
  ...
  categoryId?: string | undefined;
  path?: string | undefined;
  readonly prices?: OfferPrice[] | undefined;
  priceLists?: OfferPriceList[] | undefined;
  properties?: Property[] | undefined;
  inStockQuantity?: number;
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["prices"])) {
        ...
        for (let item of _data["prices"]) (<any>this).prices!.push(OfferPrice.fromJS(item));
      }
      if (Array.isArray(_data["priceLists"])) {
        this.priceLists = [] as any;
        for (let item of _data["priceLists"]) this.priceLists!.push(OfferPriceList.fromJS(item));
      }
      if (Array.isArray(_data["properties"])) {
        this.properties = [] as any;
        for (let item of _data["properties"]) this.properties!.push(Property.fromJS(item));
      ...
      this.productId = _data["productId"];
      this.mainProductData = _data["mainProductData"]
        ? CatalogProduct.fromJS(_data["mainProductData"])
        : <any>undefined;
      this.stagedProductId = _data["stagedProductId"];
      ...
      if (Array.isArray(_data["inventory"])) {
        ...
        for (let item of _data["inventory"]) this.inventory!.push(InventoryInfo.fromJS(item));
      }
      this.createdDate = _data["createdDate"] ? new Date(_data["createdDate"].toString()) : <any>undefined;
      this.modifiedDate = _data["modifiedDate"] ? new Date(_data["modifiedDate"].toString()) : <any>undefined;
      this.createdBy = _data["createdBy"];
...
export class OfferPriceList implements IOfferPriceList {
  name?: string | undefined;
  description?: string | undefined;
  isDefault?: boolean;
  ...
  constructor(data?: IOfferPriceList) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property)) (<any>this)[property] = (<any>data)[property];
      }
  ...
  static fromJS(data: any): OfferPriceList {
    data = typeof data === "object" ? data : {};
    let result = new OfferPriceList();
    result.init(data);
    return result;
  }
...
export class Outline implements IOutline {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data["items"])) {
        this.items = [] as any;
        for (let item of _data["items"]) this.items!.push(OutlineItem.fromJS(item));
      }
    }
  }
...
export class ProductDetails implements IProductDetails {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["descriptions"])) {
        this.descriptions = [] as any;
        for (let item of _data["descriptions"]) this.descriptions!.push(EditorialReview.fromJS(item));
      }
...
export class Property implements IProperty {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["values"])) {
        this.values = [] as any;
        for (let item of _data["values"]) this.values!.push(PropertyValue.fromJS(item));
      }
      if (Array.isArray(_data["attributes"])) {
        this.attributes = [] as any;
        for (let item of _data["attributes"]) this.attributes!.push(PropertyAttribute.fromJS(item));
      }
      if (Array.isArray(_data["displayNames"])) {
        this.displayNames = [] as any;
        for (let item of _data["displayNames"]) this.displayNames!.push(PropertyDisplayName.fromJS(item));
      }
      if (Array.isArray(_data["validationRules"])) {
        this.validationRules = [] as any;
        for (let item of _data["validationRules"]) this.validationRules!.push(PropertyValidationRule.fromJS(item));
      }
      (<any>this).validationRule = _data["validationRule"]
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.validationRules)) {
      ...
      for (let item of this.validationRules) data["validationRules"].push(item.toJSON());
    }
...
export class PropertyDictionaryItemSearchResult implements IPropertyDictionaryItemSearchResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(PropertyDictionaryItem.fromJS(item));
      }
    }
  }
...
export class SearchCommissionFeesResult implements ISearchCommissionFeesResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(CommissionFee.fromJS(item));
      }
    }
  }
...
export class SearchCustomerReviewsResult implements ISearchCustomerReviewsResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(CustomerReview.fromJS(item));
      }
    }
  }
...
export class SearchFulfillmentCentersResult implements ISearchFulfillmentCentersResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(FulfillmentCenter.fromJS(item));
      }
    }
  }
...
export class SearchImportRunHistoryQuery implements ISearchImportRunHistoryQuery {
  sellerId?: string | undefined;
  sellerName?: string | undefined;
  profileId?: string | undefined;
  jobId?: string | undefined;
  ...
  static fromJS(data: any): SearchImportRunHistoryQuery {
    data = typeof data === "object" ? data : {};
    let result = new SearchImportRunHistoryQuery();
    result.init(data);
    return result;
  }
...
export class SearchOfferProductsResult implements ISearchOfferProductsResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(OfferProduct.fromJS(item));
      }
    }
  }
...
export class SearchOffersQuery implements ISearchOffersQuery {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["sellerProductIds"])) {
        ...
        for (let item of _data["sellerProductIds"]) this.sellerProductIds!.push(item);
      }
      if (Array.isArray(_data["outerIds"])) {
        this.outerIds = [] as any;
        for (let item of _data["outerIds"]) this.outerIds!.push(item);
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.sellerProductIds)) {
      ...
      for (let item of this.sellerProductIds) data["sellerProductIds"].push(item);
    }
    if (Array.isArray(this.outerIds)) {
      data["outerIds"] = [];
      for (let item of this.outerIds) data["outerIds"].push(item);
...
export class SearchOffersResult implements ISearchOffersResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(Offer.fromJS(item));
      }
    }
  }
...
export class SearchProductsForNewOfferQuery implements ISearchProductsForNewOfferQuery {
  ...
  init(_data?: any) {
    if (_data) {
      this.sellerId = _data["sellerId"];
      this.sellerName = _data["sellerName"];
      this.searchFromSellerOnly = _data["searchFromSellerOnly"];
      this.responseGroup = _data["responseGroup"];
      this.objectType = _data["objectType"];
      if (Array.isArray(_data["objectTypes"])) {
        this.objectTypes = [] as any;
  ...
  toJSON(data?: any) {
    ...
    data["sellerId"] = this.sellerId;
    data["sellerName"] = this.sellerName;
    data["searchFromSellerOnly"] = this.searchFromSellerOnly;
    data["responseGroup"] = this.responseGroup;
    data["objectType"] = this.objectType;
    if (Array.isArray(this.objectTypes)) {
      data["objectTypes"] = [];
...
export class SearchProductsQuery implements ISearchProductsQuery {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["publishedProductsIds"])) {
        ...
        for (let item of _data["publishedProductsIds"]) this.publishedProductsIds!.push(item);
      }
      if (Array.isArray(_data["stagedProductsIds"])) {
        this.stagedProductsIds = [] as any;
        for (let item of _data["stagedProductsIds"]) this.stagedProductsIds!.push(item);
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.publishedProductsIds)) {
      ...
      for (let item of this.publishedProductsIds) data["publishedProductsIds"].push(item);
    }
    if (Array.isArray(this.stagedProductsIds)) {
      data["stagedProductsIds"] = [];
      for (let item of this.stagedProductsIds) data["stagedProductsIds"].push(item);
    }
...
export class SearchProductsResult implements ISearchProductsResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(SellerProduct.fromJS(item));
      }
    }
  }
...
export class SearchSellerUsersResult implements ISearchSellerUsersResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(SellerUser.fromJS(item));
      }
    }
  }
...
export class SearchSellersResult implements ISearchSellersResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(Seller.fromJS(item));
      }
    }
  }
...
export class SearchStateMachineDefinitionsResult implements ISearchStateMachineDefinitionsResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(StateMachineDefinition.fromJS(item));
      }
    }
  }
...
export class SearchStateMachineInstancesResult implements ISearchStateMachineInstancesResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(StateMachineInstance.fromJS(item));
      }
    }
  }
...
export class SearchVideosQuery implements ISearchVideosQuery {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data["ownerIds"])) {
        ...
        for (let item of _data["ownerIds"]) this.ownerIds!.push(item);
      }
      this.ownerType = _data["ownerType"];
      this.responseGroup = _data["responseGroup"];
      this.objectType = _data["objectType"];
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.ownerIds)) {
      data["ownerIds"] = [];
      for (let item of this.ownerIds) data["ownerIds"].push(item);
    }
    data["ownerType"] = this.ownerType;
    data["responseGroup"] = this.responseGroup;
    data["objectType"] = this.objectType;
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["groups"])) {
        ...
        for (let item of _data["groups"]) (<any>this).groups!.push(item);
      }
      if (Array.isArray(_data["addresses"])) {
        (<any>this).addresses = [] as any;
        for (let item of _data["addresses"]) (<any>this).addresses!.push(CustomerAddress.fromJS(item));
      }
      if (Array.isArray(_data["phones"])) {
        (<any>this).phones = [] as any;
        for (let item of _data["phones"]) (<any>this).phones!.push(item);
      }
      if (Array.isArray(_data["emails"])) {
        (<any>this).emails = [] as any;
        for (let item of _data["emails"]) (<any>this).emails!.push(item);
      }
      (<any>this).description = _data["description"];
      this.createdDate = _data["createdDate"] ? new Date(_data["createdDate"].toString()) : <any>undefined;
      this.modifiedDate = _data["modifiedDate"] ? new Date(_data["modifiedDate"].toString()) : <any>undefined;
...
export class SellerOrder implements ISellerOrder {
  ...
  static fromJS(data: any): SellerOrder {
    data = typeof data === "object" ? data : {};
    let result = new SellerOrder();
    result.init(data);
    return result;
  }
...
export class StateMachineDefinition implements IStateMachineDefinition {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["states"])) {
        this.states = [] as any;
        for (let item of _data["states"]) this.states!.push(StateMachineState.fromJS(item));
      }
      this.createdDate = _data["createdDate"] ? new Date(_data["createdDate"].toString()) : <any>undefined;
      this.modifiedDate = _data["modifiedDate"] ? new Date(_data["modifiedDate"].toString()) : <any>undefined;
      this.createdBy = _data["createdBy"];
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.states)) {
      data["states"] = [];
      for (let item of this.states) data["states"].push(item.toJSON());
    }
    data["createdDate"] = this.createdDate ? this.createdDate.toISOString() : <any>undefined;
    data["modifiedDate"] = this.modifiedDate ? this.modifiedDate.toISOString() : <any>undefined;
    data["createdBy"] = this.createdBy;
...
export class StateMachineInstance implements IStateMachineInstance {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      (<any>this).currentState = _data["currentState"]
        ? StateMachineState.fromJS(_data["currentState"])
        : <any>undefined;
...
export class StateMachineState implements IStateMachineState {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["transitions"])) {
        ...
        for (let item of _data["transitions"]) this.transitions!.push(StateMachineTransition.fromJS(item));
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.transitions)) {
      data["transitions"] = [];
      for (let item of this.transitions) data["transitions"].push(item.toJSON());
    }
    return data;
  }
}
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data["clientTypes"])) {
        ...
        for (let item of _data["clientTypes"]) this.clientTypes!.push(item);
      }
    }
  }
...
export class SyncProgressInfo implements ISyncProgressInfo {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["syncItemStats"])) {
        ...
        for (let item of _data["syncItemStats"]) this.syncItemStats!.push(SyncProgressInfo.fromJS(item));
      }
      if (Array.isArray(_data["errors"])) {
        this.errors = [] as any;
        for (let item of _data["errors"]) this.errors!.push(item);
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.syncItemStats)) {
      data["syncItemStats"] = [];
      for (let item of this.syncItemStats) data["syncItemStats"].push(item.toJSON());
    }
    if (Array.isArray(this.errors)) {
      data["errors"] = [];
      for (let item of this.errors) data["errors"].push(item);
...
export class SyncPushNotification implements ISyncPushNotification {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["importStats"])) {
        ...
        for (let item of _data["importStats"]) this.importStats!.push(SyncProgressInfo.fromJS(item));
      }
      if (Array.isArray(_data["exportStats"])) {
        this.exportStats = [] as any;
        for (let item of _data["exportStats"]) this.exportStats!.push(SyncProgressInfo.fromJS(item));
      }
      this.serverId = _data["serverId"];
      this.creator = _data["creator"];
      this.created = _data["created"] ? new Date(_data["created"].toString()) : <any>undefined;
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.importStats)) {
      data["importStats"] = [];
      for (let item of this.importStats) data["importStats"].push(item.toJSON());
    }
    if (Array.isArray(this.exportStats)) {
      data["exportStats"] = [];
      for (let item of this.exportStats) data["exportStats"].push(item.toJSON());
    }
    data["serverId"] = this.serverId;
    data["creator"] = this.creator;
    data["created"] = this.created ? this.created.toISOString() : <any>undefined;
...
export class UpdateSellerOrderCommand implements IUpdateSellerOrderCommand {
  sellerId?: string | undefined;
  sellerName?: string | undefined;
  order!: SellerOrder;
  ...
  static fromJS(data: any): UpdateSellerOrderCommand {
    data = typeof data === "object" ? data : {};
    let result = new UpdateSellerOrderCommand();
    result.init(data);
    return result;
  }
...
export interface IUpdateSellerOrderCommand {
  sellerId?: string | undefined;
  sellerName?: string | undefined;
  order: SellerOrder;
}
...
export class VideoSearchResult implements IVideoSearchResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(Video.fromJS(item));
      }
    }
  }
