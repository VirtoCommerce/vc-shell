        ...
        if (_data) {
            ...
            if (Array.isArray(_data["prices"])) {
                ...
                for (let item of _data["prices"])
                    (<any>this).prices!.push(OfferPrice.fromJS(item));
            }
            if (Array.isArray(_data["priceLists"])) {
                this.priceLists = [] as any;
                for (let item of _data["priceLists"])
                    this.priceLists!.push(OfferPriceList.fromJS(item));
            }
            if (Array.isArray(_data["properties"])) {
                this.properties = [] as any;
                for (let item of _data["properties"])
...
export class SearchProductsQuery implements ISearchProductsQuery {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["stagedProductsIds"])) {
                ...
                for (let item of _data["stagedProductsIds"])
                    this.stagedProductsIds!.push(item);
            }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.stagedProductsIds)) {
            ...
            for (let item of this.stagedProductsIds)
                data["stagedProductsIds"].push(item);
        }
