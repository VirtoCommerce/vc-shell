...
:root {
  ...
  --form-checkbox-image: url("data:image/svg+xml;utf8,<svg width='14' height='14' viewBox='0 0 14 14' fill='none' xmlns='http://www.w3.org/2000/svg'><rect x='0.8' y='0.8' width='12.4' height='12.4' rx='1.7' fill='white' stroke='%23ABC0D3' stroke-width='1.6'/></svg>");
...
.vc-form-checkbox {
  ...
  &__checkmark:before {
    ...
    background-size: auto var(--form-checkbox-size);
    background-color: var(--form-checkbox-background-color);
    background-image: var(--form-checkbox-image);
  }

  &__input:checked ~ &__checkmark:before {
    background-image: var(--form-checkbox-image-checked);
  }
}
</style>
