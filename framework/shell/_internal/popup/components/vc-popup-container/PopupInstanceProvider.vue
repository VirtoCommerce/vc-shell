 ...
 *
 * provide/inject rather than a prop: the container renders an arbitrary component, and
 * writing `modelValue` into it would collide with popups that own that prop. A popup that
 * ignores the context is unmounted by the fallback timer in `usePopup.close`.
 */
