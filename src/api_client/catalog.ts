...
export class CatalogModuleCategoriesClient extends AuthApiBase {
  ...
  getNewCategory(catalogId: string, parentCategoryId?: string | undefined): Promise<Category> {
    ...
    if (parentCategoryId === null) throw new Error("The parameter 'parentCategoryId' cannot be null.");
...
export class CatalogModuleIndexedSearchClient extends AuthApiBase {
  ...
  getProductSuggestions(
    ...
    else if (catalogId !== undefined) url_ += "CatalogId=" + encodeURIComponent("" + catalogId) + "&";
...
export class CatalogModuleMeasuresClient extends AuthApiBase {
  private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
   ...
   * @return Success
   */
  getMeasureById(id: string): Promise<Measure> {
    let url_ = this.baseUrl + "/api/catalog/measures/{id}";
    if (id === undefined || id === null) throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.processGetMeasureById(_response);
      });
  }

  protected processGetMeasureById(response: Response): Promise<Measure> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
    ...
    return Promise.resolve<Measure>(null as any);
  }
   ...
   * @return Success
   */
  searchMeasures(body?: MeasureSearchCriteria | undefined): Promise<MeasureSearchResult> {
    let url_ = this.baseUrl + "/api/catalog/measures/search";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.processSearchMeasures(_response);
      });
  }

  protected processSearchMeasures(response: Response): Promise<MeasureSearchResult> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
        result200 = MeasureSearchResult.fromJS(resultData200);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
    ...
    return Promise.resolve<MeasureSearchResult>(null as any);
  }
   ...
   * @return Success
   */
  createMeasure(body?: Measure | undefined): Promise<Measure> {
    let url_ = this.baseUrl + "/api/catalog/measures";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.processCreateMeasure(_response);
      });
  }

  protected processCreateMeasure(response: Response): Promise<Measure> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @return Success
   */
  updateMeasure(body?: Measure | undefined): Promise<void> {
    let url_ = this.baseUrl + "/api/catalog/measures";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.processUpdateMeasure(_response);
      });
  }

  protected processUpdateMeasure(response: Response): Promise<void> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @return Success
   */
  deleteMeasures(ids?: string[] | undefined): Promise<void> {
    let url_ = this.baseUrl + "/api/catalog/measures?";
    if (ids === null) throw new Error("The parameter 'ids' cannot be null.");
    else if (ids !== undefined)
      ids &&
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.processDeleteMeasures(_response);
      });
  }

  protected processDeleteMeasures(response: Response): Promise<void> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
...
export class CatalogModuleProductsClient extends AuthApiBase {
  ...
  getByCodes(
    ...
    if (catalogId === undefined || catalogId === null) throw new Error("The parameter 'catalogId' must be defined.");
    url_ = url_.replace("{catalogId}", encodeURIComponent("" + catalogId));
    if (responseGroup === null) throw new Error("The parameter 'responseGroup' cannot be null.");
  ...
  protected processGetByCodes(response: Response): Promise<CatalogProduct[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(CatalogProduct.fromJS(item));
        } else {
          result200 = <any>null;
        }
        return result200;
...
export class CatalogModulePropertiesClient extends AuthApiBase {
  ...
  getProperty(propertyId: string): Promise<Property> {
    ...
    if (propertyId === undefined || propertyId === null) throw new Error("The parameter 'propertyId' must be defined.");
  ...
  deleteProperty(id?: string | undefined, doDeleteValues?: boolean | undefined): Promise<void> {
    ...
    if (doDeleteValues === null) throw new Error("The parameter 'doDeleteValues' cannot be null.");
    else if (doDeleteValues !== undefined) url_ += "doDeleteValues=" + encodeURIComponent("" + doDeleteValues) + "&";
    url_ = url_.replace(/[?&]$/, "");
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["labels"])) {
        this.labels = [] as any;
        for (let item of _data["labels"]) this.labels!.push(AggregationLabel.fromJS(item));
      }
      if (Array.isArray(_data["items"])) {
        this.items = [] as any;
        for (let item of _data["items"]) this.items!.push(AggregationItem.fromJS(item));
      }
    }
  }
...
export class Catalog implements ICatalog {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.outerId = _data["outerId"];
      (<any>this).defaultLanguage = _data["defaultLanguage"]
        ? CatalogLanguage.fromJS(_data["defaultLanguage"])
        : <any>undefined;
      if (Array.isArray(_data["languages"])) {
        this.languages = [] as any;
        for (let item of _data["languages"]) this.languages!.push(CatalogLanguage.fromJS(item));
      }
...
export class CatalogListEntrySearchCriteria implements ICatalogListEntrySearchCriteria {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["excludeProductTypes"])) {
        ...
        for (let item of _data["excludeProductTypes"]) this.excludeProductTypes!.push(item);
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.excludeProductTypes)) {
      ...
      for (let item of this.excludeProductTypes) data["excludeProductTypes"].push(item);
    }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(Catalog.fromJS(item));
      }
    }
  }
...
export class CategoryIndexedSearchResult implements ICategoryIndexedSearchResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["items"])) {
        this.items = [] as any;
        for (let item of _data["items"]) this.items!.push(Category.fromJS(item));
      }
      if (Array.isArray(_data["aggregations"])) {
        this.aggregations = [] as any;
        for (let item of _data["aggregations"]) this.aggregations!.push(Aggregation.fromJS(item));
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.aggregations)) {
      data["aggregations"] = [];
      for (let item of this.aggregations) data["aggregations"].push(item.toJSON());
    }
    return data;
  }
}
...
export class ListEntriesMoveRequest implements IListEntriesMoveRequest {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["listEntries"])) {
        ...
        for (let item of _data["listEntries"]) this.listEntries!.push(ListEntryBase.fromJS(item));
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.listEntries)) {
      data["listEntries"] = [];
      for (let item of this.listEntries) data["listEntries"].push(item.toJSON());
    }
    return data;
  }
}
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data["listEntries"])) {
        ...
        for (let item of _data["listEntries"]) (<any>this).listEntries!.push(ListEntryBase.fromJS(item));
      }
      this.totalCount = _data["totalCount"];
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(ListEntryBase.fromJS(item));
      }
    }
  }
...
export class Measure implements IMeasure {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["units"])) {
        this.units = [] as any;
        for (let item of _data["units"]) this.units!.push(MeasureUnit.fromJS(item));
      }
      this.createdDate = _data["createdDate"] ? new Date(_data["createdDate"].toString()) : <any>undefined;
      this.modifiedDate = _data["modifiedDate"] ? new Date(_data["modifiedDate"].toString()) : <any>undefined;
      this.createdBy = _data["createdBy"];
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.units)) {
      data["units"] = [];
      for (let item of this.units) data["units"].push(item.toJSON());
    }
    data["createdDate"] = this.createdDate ? this.createdDate.toISOString() : <any>undefined;
    data["modifiedDate"] = this.modifiedDate ? this.modifiedDate.toISOString() : <any>undefined;
    data["createdBy"] = this.createdBy;
...
export class MeasureSearchCriteria implements IMeasureSearchCriteria {
  responseGroup?: string | undefined;
  objectType?: string | undefined;
  objectTypes?: string[] | undefined;
  objectIds?: string[] | undefined;
  ...
  constructor(data?: IMeasureSearchCriteria) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property)) (<any>this)[property] = (<any>data)[property];
      }
  ...
  static fromJS(data: any): MeasureSearchCriteria {
    data = typeof data === "object" ? data : {};
    let result = new MeasureSearchCriteria();
    result.init(data);
    return result;
  }
...
export interface IMeasureSearchCriteria {
  responseGroup?: string | undefined;
  objectType?: string | undefined;
  objectTypes?: string[] | undefined;
  objectIds?: string[] | undefined;
...
export class MeasureSearchResult implements IMeasureSearchResult {
  totalCount?: number;
  results?: Measure[] | undefined;

  constructor(data?: IMeasureSearchResult) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property)) (<any>this)[property] = (<any>data)[property];
      }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["results"])) {
        this.results = [] as any;
        for (let item of _data["results"]) this.results!.push(Measure.fromJS(item));
      }
    }
  }

  static fromJS(data: any): MeasureSearchResult {
    data = typeof data === "object" ? data : {};
    let result = new MeasureSearchResult();
    result.init(data);
    return result;
  }
...
export interface IMeasureSearchResult {
  totalCount?: number;
  results?: Measure[] | undefined;
}
...
export class ProductIndexedSearchCriteria implements IProductIndexedSearchCriteria {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["excludeAggregations"])) {
        ...
        for (let item of _data["excludeAggregations"]) this.excludeAggregations!.push(item);
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.excludeAggregations)) {
      ...
      for (let item of this.excludeAggregations) data["excludeAggregations"].push(item);
    }
...
export class ProductIndexedSearchResult implements IProductIndexedSearchResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["items"])) {
        this.items = [] as any;
        for (let item of _data["items"]) this.items!.push(CatalogProduct.fromJS(item));
      }
      if (Array.isArray(_data["aggregations"])) {
        this.aggregations = [] as any;
        for (let item of _data["aggregations"]) this.aggregations!.push(Aggregation.fromJS(item));
...
export class SuggestionResponse implements ISuggestionResponse {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data["suggestions"])) {
        ...
        for (let item of _data["suggestions"]) this.suggestions!.push(item);
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.suggestions)) {
      data["suggestions"] = [];
      for (let item of this.suggestions) data["suggestions"].push(item);
    }
    return data;
  }
}
...
export class ValidationResult implements IValidationResult {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data["errors"])) {
        ...
        for (let item of _data["errors"]) (<any>this).errors!.push(ValidationFailure.fromJS(item));
      }
      if (Array.isArray(_data["ruleSetsExecuted"])) {
        (<any>this).ruleSetsExecuted = [] as any;
        for (let item of _data["ruleSetsExecuted"]) (<any>this).ruleSetsExecuted!.push(item);
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.ruleSetsExecuted)) {
      ...
      for (let item of this.ruleSetsExecuted) data["ruleSetsExecuted"].push(item);
    }
    return data;
  }
}
