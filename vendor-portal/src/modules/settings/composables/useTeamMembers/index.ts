...
interface ExtendedSellerUserDetails extends SellerUserDetails {
  id: string;
}
...
interface IUseTeamMembers {
  ...
  userDetails: Ref<ExtendedSellerUserDetails>;
...
export default (options?: IUseTeamMembersOptions): IUseTeamMembers => {
  ...
  const userDetails = ref(new SellerUserDetails() as ExtendedSellerUserDetails);
  ...
  async function handleUserDetailsItem(user: ISellerUser) {
    userDetails.value = Object.assign(
      {},
      new SellerUserDetails(
        user as ISellerUserDetails
      ) as ExtendedSellerUserDetails
    );
  ...
  async function resetEntries() {
    userDetails.value = Object.assign(
      {},
      userDetailsCopy as ExtendedSellerUserDetails
    );
  }
