...
`;
  ...
  /**
   * DEPRECATED - This legacy file is archived
   * Use AIGenerationGuideBuilder from ai-generation-guide-builder.ts instead.
   *
   * @deprecated
   * @since 0.8.0
   */
  async buildGuideAsync(_context: BladeGenerationContext): Promise<AIGenerationGuide> {
    throw new Error("Legacy class deprecated. Use AIGenerationGuideBuilder from ai-generation-guide-builder.ts");
  }
}
