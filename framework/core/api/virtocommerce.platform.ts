...
export class ExternalSignInClient extends AuthApiBase {
    ...
    signIn(authenticationType?: string | undefined, returnUrl?: string | undefined, storeId?: string | undefined, oidcUrl?: string | undefined, callbackUrl?: string | undefined): Promise<void> {
        ...
        if (oidcUrl === null)
            throw new Error("The parameter 'oidcUrl' cannot be null.");
        else if (oidcUrl !== undefined)
            url_ += "OidcUrl=" + encodeURIComponent("" + oidcUrl) + "&";
        if (callbackUrl === null)
            throw new Error("The parameter 'callbackUrl' cannot be null.");
    ...
    protected processGetDeveloperTools(response: Response): Promise<DeveloperToolDescriptor[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(DeveloperToolDescriptor.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    protected processGetAllDynamicProperties(response: Response): Promise<DynamicProperty[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(DynamicProperty.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    protected processGetAllDictionaryItems(response: Response): Promise<DynamicPropertyDictionaryItem[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(DynamicPropertyDictionaryItem.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    protected processGetDictionaryValues(response: Response): Promise<KeyValue[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(KeyValue.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
...
export class SecurityClient extends AuthApiBase {
    ...
    generateUserToken(userId: string, tokenProvider?: string | undefined, purpose?: string | undefined): Promise<string> {
        ...
        if (tokenProvider === null)
            throw new Error("The parameter 'tokenProvider' cannot be null.");
...
export class CryptoProviderCache implements ICryptoProviderCache {
    ...
    static fromJS(data: any): CryptoProviderCache {
        data = typeof data === 'object' ? data : {};
        let result = new CryptoProviderCache();
        result.init(data);
        return result;
    }
...
export class CryptoProviderFactory implements ICryptoProviderFactory {
    ...
    init(_data?: any) {
        if (_data) {
            (<any>this).cryptoProviderCache = _data["cryptoProviderCache"] ? CryptoProviderCache.fromJS(_data["cryptoProviderCache"]) : <any>undefined;
...
export class DeveloperToolDescriptor implements IDeveloperToolDescriptor {
    name?: string | undefined;
    ...
    static fromJS(data: any): DeveloperToolDescriptor {
        data = typeof data === 'object' ? data : {};
        let result = new DeveloperToolDescriptor();
        result.init(data);
        return result;
    }
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["localizedValues"])) {
                ...
                for (let item of _data["localizedValues"])
                    this.localizedValues!.push(LocalizedValue.fromJS(item));
            }
        }
    }
...
export class ICryptoProvider implements IICryptoProvider {
    ...
    static fromJS(data: any): ICryptoProvider {
        data = typeof data === 'object' ? data : {};
        let result = new ICryptoProvider();
        result.init(data);
        return result;
    }
...
export class JsonWebKey implements IJsonWebKey {
    ...
    init(_data?: any) {
        if (_data) {
            if (_data["additionalData"]) {
                (<any>this).additionalData = {} as any;
                for (let key in _data["additionalData"]) {
                    if (_data["additionalData"].hasOwnProperty(key))
                        (<any>(<any>this).additionalData)![key] = _data["additionalData"][key];
                }
            }
            this.alg = _data["alg"];
            this.crv = _data["crv"];
            ...
            if (Array.isArray(_data["keyOps"])) {
                (<any>this).keyOps = [] as any;
                for (let item of _data["keyOps"])
                    (<any>this).keyOps!.push(item);
            }
            this.kid = _data["kid"];
            this.kty = _data["kty"];
            this.n = _data["n"];
            ...
            if (Array.isArray(_data["x5c"])) {
                ...
                for (let item of _data["x5c"])
                    (<any>this).x5c!.push(item);
            }
            this.x5t = _data["x5t"];
            this.x5tS256 = _data["x5tS256"];
            this.x5u = _data["x5u"];
            this.y = _data["y"];
            (<any>this).keySize = _data["keySize"];
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.keyOps)) {
            data["keyOps"] = [];
            for (let item of this.keyOps)
                data["keyOps"].push(item);
        }
        data["kid"] = this.kid;
        data["kty"] = this.kty;
        data["n"] = this.n;
...
export class JsonWebKeySet implements IJsonWebKeySet {
    readonly additionalData?: { [key: string]: any; } | undefined;
    ...
    constructor(data?: IJsonWebKeySet) {
        ...
        if (!data) {
            this.skipUnresolvedJsonWebKeys = true;
        }
    }
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["keys"])) {
                ...
                for (let item of _data["keys"])
                    (<any>this).keys!.push(JsonWebKey.fromJS(item));
            }
            this.skipUnresolvedJsonWebKeys = _data["skipUnresolvedJsonWebKeys"] !== undefined ? _data["skipUnresolvedJsonWebKeys"] : true;
        }
    }

    static fromJS(data: any): JsonWebKeySet {
        data = typeof data === 'object' ? data : {};
        let result = new JsonWebKeySet();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["skipUnresolvedJsonWebKeys"] = this.skipUnresolvedJsonWebKeys;
        return data;
    }
}
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items!.push(DictionaryItem.fromJS(item));
            }
        }
    }
        ...
        if (_data) {
            if (Array.isArray(_data["settings"])) {
                ...
                for (let item of _data["settings"])
                    this.settings!.push(LocalizableSetting.fromJS(item));
            }
...
export class OpenIddictApplicationDescriptor implements IOpenIddictApplicationDescriptor {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.jsonWebKeySet = _data["jsonWebKeySet"] ? JsonWebKeySet.fromJS(_data["jsonWebKeySet"]) : <any>undefined;
            ...
            if (_data["settings"]) {
                ...
                for (let key in _data["settings"]) {
                    if (_data["settings"].hasOwnProperty(key))
                        (<any>(<any>this).settings)![key] = _data["settings"][key];
                }
            }
            this.type = _data["type"];
        }
    ...
    toJSON(data?: any) {
        ...
        data["jsonWebKeySet"] = this.jsonWebKeySet ? this.jsonWebKeySet.toJSON() : <any>undefined;
