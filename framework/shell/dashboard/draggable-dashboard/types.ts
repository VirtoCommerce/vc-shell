 ...
 * live size. Size is optional because it becomes known only once Gridstack reports
 * it or a saved layout supplies it; until then the declared `size` is the source.
 * Keeping it here is what makes a resize survive a reload.
 */
