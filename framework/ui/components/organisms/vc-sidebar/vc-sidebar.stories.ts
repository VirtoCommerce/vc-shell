...
export const ElevatedPanel: Story = {
  render: (args) => ({
    ...
    template: `
      <div class="tw-min-h-screen tw-bg-gradient-to-br tw-from-additional-50 tw-to-neutrals-100 tw-p-10">
        <div class="tw-mx-auto tw-max-w-5xl tw-rounded-2xl tw-border tw-border-solid tw-border-neutrals-200 tw-bg-additional-50 tw-p-8">
          <div class="tw-flex tw-items-center tw-justify-between tw-gap-4">
            <div>
              <p class="tw-text-sm tw-text-neutrals-500">Sidebar demo</p>
              <p class="tw-text-2xl tw-font-semibold tw-text-neutrals-900">Workspace shell</p>
            </div>
          ...
          <p class="tw-mt-3 tw-text-sm tw-text-neutrals-600">
        ...
        >
          ...
          <div class="tw-space-y-6 tw-p-6">
            <section class="tw-space-y-2">
              <p class="tw-text-sm tw-font-semibold tw-text-neutrals-900">Visibility</p>
              <p class="tw-text-sm tw-text-neutrals-600">Public project is visible to all authenticated users.</p>
              <VcButton variant="outline" size="sm">Change visibility</VcButton>
            </section>

            <section class="tw-space-y-2">
              <p class="tw-text-sm tw-font-semibold tw-text-neutrals-900">Publishing</p>
              <p class="tw-text-sm tw-text-neutrals-600">3 unpublished changes are waiting for review.</p>
...
export const LeftMinimal: Story = {
  ...
  render: (args) => ({
    ...
    template: `
      <div class="tw-min-h-screen tw-bg-additional-50 tw-p-10">
        <VcSidebar v-bind="args" :model-value="opened" @update:modelValue="opened = $event">
          <div class="tw-space-y-4 tw-p-5">
            <div class="tw-rounded-lg tw-border tw-border-solid tw-border-neutrals-200 tw-p-4">
              <p class="tw-text-sm tw-font-semibold tw-text-neutrals-900">Status</p>
              <p class="tw-mt-1 tw-text-sm tw-text-neutrals-600">Published, Draft, Scheduled</p>
            </div>
            <div class="tw-rounded-lg tw-border tw-border-solid tw-border-neutrals-200 tw-p-4">
              <p class="tw-text-sm tw-font-semibold tw-text-neutrals-900">Price range</p>
              <p class="tw-mt-1 tw-text-sm tw-text-neutrals-600">$10 to $350</p>
            </div>
          </div>
          <template #footer>
      ...
      <div class="tw-min-h-screen tw-bg-neutrals-100 tw-p-10">
        ...
        <VcSidebar v-bind="args" :model-value="opened" @update:modelValue="opened = $event">
          <div class="tw-grid tw-grid-cols-1 tw-gap-2 tw-p-4 md:tw-grid-cols-2">
            <button class="tw-rounded-lg tw-border tw-border-solid tw-border-neutrals-200 tw-bg-transparent tw-p-4 tw-text-left hover:tw-bg-primary-50">
              <p class="tw-text-sm tw-font-semibold">Duplicate</p>
              <p class="tw-text-xs tw-text-neutrals-600">Create a copy of this entry</p>
            </button>
            <button class="tw-rounded-lg tw-border tw-border-solid tw-border-neutrals-200 tw-bg-transparent tw-p-4 tw-text-left hover:tw-bg-primary-50">
              <p class="tw-text-sm tw-font-semibold">Archive</p>
              <p class="tw-text-xs tw-text-neutrals-600">Hide from active lists</p>
            </button>
            <button class="tw-rounded-lg tw-border tw-border-solid tw-border-neutrals-200 tw-bg-transparent tw-p-4 tw-text-left hover:tw-bg-primary-50">
              <p class="tw-text-sm tw-font-semibold tw-text-danger-600">Delete</p>
              <p class="tw-text-xs tw-text-neutrals-600">Permanently remove this entry</p>
            </button>
          </div>
        </VcSidebar>
      </div>
