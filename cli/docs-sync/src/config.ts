...
export const ALLOWED_CATEGORIES = ["components", "composables", "concepts", "reference"] as const;
...
export const MANUAL_ONLY_FOLDERS = ["introduction", "getting-started", "guides", "reference/migration"];
