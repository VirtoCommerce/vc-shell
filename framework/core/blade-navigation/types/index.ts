...
export type BladeInstanceConstructor<_T extends Component = Component> = Component & {
...
/**
 * A banner displayed at the top of a blade (between header and toolbar).
 * Used for error, warning, info, and success messages.
 */
export interface IBladeBanner {
  /** Unique identifier (auto-generated by addBanner) */
  id: string;
  /** Visual variant — determines color scheme and default icon */
  variant: "danger" | "warning" | "info" | "success";
  /** Plain text message */
  message?: string;
  /** Custom render function for complex content (takes priority over message) */
  render?: () => VNode;
  /** Whether the user can dismiss this banner (default: false) */
  dismissible?: boolean;
  /** Override the default variant icon (lucide icon name) */
  icon?: string;
  ...
  /** @internal System banners (error/modified) — protected from clearBanners() */
  _system?: boolean;
}

export const BladeBannersKey: InjectionKey<Ref<IBladeBanner[]>> = Symbol("BladeBanners");
