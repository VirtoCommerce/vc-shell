...
import VcBladeNavigation from "@shared/components/blade-navigation/components/vc-blade-navigation/vc-blade-navigation-new.vue";

// Mock blade-navigation composables and utils to avoid full plugin setup
vi.mock("@shared/components/blade-navigation/composables/useBladeStack", () => ({
  useBladeStack: () => ({
    blades: ref([]),
...
vi.mock("@shared/components/blade-navigation/composables/useBladeMessaging", () => ({
  useBladeMessaging: () => ({
